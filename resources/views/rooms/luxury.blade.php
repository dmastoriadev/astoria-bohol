...
@section('title', 'Luxury Room | Astoria Bohol')
...
@php
  ...
  $gallery = [
    ['src' => asset('images/Rooms/luxury1.webp'), 'alt' => 'Luxury Room'],
    ['src' => asset('images/Rooms/luxury2.webp'), 'alt' => 'Luxury Room'],
    ['src' => asset('images/Rooms/luxury3.webp'), 'alt' => 'Luxury Room'],
    ['src' => asset('images/Rooms/luxury4.webp'), 'alt' => 'Luxury Room'],
    ['src' => asset('images/Rooms/luxury5.webp'), 'alt' => 'Luxury Room'],
  ];
        ...
        <div class="h-full rounded-2xl border border-gray-200 bg-white p-6 md:p-7 lg:p-9 shadow-sm">
          ...
          <div class="flex flex-wrap gap-2">
            <span class="inline-flex items-center gap-1.5 text-xs font-semibold rounded-full px-2.5 py-1 bg-[#3F2021] text-[#E6E7E8] lg:gap-2 lg:text-base lg:px-3.5 lg:py-1.5">
              <i class="fa-solid fa-bed lg:text-lg"></i>2 Queen beds
            </span>
          </div>

          {{-- Policies (updated) --}}
            <p class="mt-4 text-[14.5px] leading-7 lg:text-lg lg:leading-8">
             With a touch of flair in each of the Luxury Rooms, the rich culture of Bohol is reflected in every detail of our sophisticated spaces.
